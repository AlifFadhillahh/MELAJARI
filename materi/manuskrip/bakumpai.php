...
<head>
    ...
    <title>Manuskrip - Bakumpai</title>
...
<body style="background-image: url('/assets/bg/Suku-Kalimantan.webp'); background-size: cover;">
    ...
    <section class="materi-grid">
        ...
        <div class="container">
            ...
            <div class="content-container">
                <div class="course-content" id="course-content">
                    <h1 class="course-title" style="margin-top: 25px;margin-left: 30px; color: aliceblue;">Manuskrip
                        Suku Bakumpai
                    </h1>
        ...
        <script src="/js/materi/manuskrip/bakumpai.js"></script>
</body>
