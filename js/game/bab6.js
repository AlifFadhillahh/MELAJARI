...
function createGridAndWords() {
  ...
  console.log(
    "Words for Current Puzzle (level1):",
    findWordPuzzle.level1[currentPuzzle].words
  );
  const words = findWordPuzzle.level1[currentPuzzle].words;
...
function checkSelectedCells() {
  ...
  if (foundWords.size === findWordPuzzle.level1[currentPuzzle].words.length) {
...
function getSelectedWord() {
  const { words } = findWordPuzzle.level1[currentPuzzle];
  let word = "";
...
function retryPuzzle() {
  ...
  createGrid(grid);
  createWordContainer(findWordPuzzle.level1[currentPuzzle].words);
  setHintMessage(findWordPuzzle.level1[currentPuzzle].hint);
}
